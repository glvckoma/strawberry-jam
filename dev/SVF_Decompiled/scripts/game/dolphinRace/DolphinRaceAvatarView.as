package game.dolphinRace
{
   ...
   public class DolphinRaceAvatarView extends AvatarView
   {
      ...
      public function DolphinRaceAvatarView()
      {
         super();
      }
      
      public function InitDolphinRaceAvatarView() : void
      {
         _layerAnim.avDefId = 19;
