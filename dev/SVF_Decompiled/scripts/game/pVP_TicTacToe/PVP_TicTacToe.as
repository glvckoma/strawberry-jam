package game.pVP_TicTacToe
{
   ...
   public class PVP_TicTacToe extends GameBase implements IMinigame
   {
      ...
      private var _audio:Array = ["pvp_stinger_draw.mp3","pvp_stinger_fail.mp3","pvp_stinger_win.mp3","pvp_stinger_turn.mp3","ttt_select.mp3","ttt_rollover.mp3","popup_pvp_RedText_enter.mp3","popup_pvp_RedText_exit.mp3","popup_pvp_YourTurn_enter.mp3","popup_pvp_YourTurn_exit.mp3","pvp_ttt_timer_count_down.mp3","pvp_timeUp_buzzer.mp3"];
      ...
      private var _soundNameRedTextEnter:String = _audio[6];
      
      private var _soundNameRedTextExit:String = _audio[7];
      
      private var _soundNameYourTurnEnter:String = _audio[8];
      
      private var _soundNameYourTurnExit:String = _audio[9];
      
      private var _soundNameTimerCount:String = _audio[10];
      
      private var _soundNameTimerDone:String = _audio[11];
      
      public function PVP_TicTacToe()
      {
         super();
      ...
      private function loadSounds() : void
      {
         ...
         _soundMan.addSoundByName(_audioByName[_soundNameWin],_soundNameWin,0.6);
         _soundMan.addSoundByName(_audioByName[_soundNameTurn],_soundNameTurn,0.6);
         _soundMan.addSoundByName(_audioByName[_soundNameSelect],_soundNameSelect,0.35);
         _soundMan.addSoundByName(_audioByName[_soundNameRollover],_soundNameRollover,0.35);
      ...
      private function init() : void
      {
         ...
         if(!_bInit)
         {
            ...
            addChild(_layerMain);
            addChild(_guiLayer);
            loadScene("PVP_TicTacToe/room_main.xroom",_audio);
            _bInit = true;
         }
         else
         {
      ...
      override protected function sceneLoaded(param1:Event) : void
      {
         ...
         startGame();
         _theGame.loader.content.player1Name.text = "";
         _theGame.loader.content.player2Name.text = "";
      ...
      public function message(param1:Array) : void
      {
         ...
         else if(param1[0] == "mm")
         {
            ...
            else if(param1[2] == "mark")
            {
               ...
               _theGame.loader.content.setMark(parseInt(param1[3]) == 0,parseInt(param1[4]),parseInt(param1[5]));
            ...
            if(_serverStarted)
            {
               ...
               if(_gameState == 5)
               {
                  ...
                  if(_theGame.loader.content.marked)
                  {
                     ...
                     _loc2_[2] = String(int(_theGame.loader.content.markedY));
                     MinigameManager.msg(_loc2_);
                  }
                  else if(_boardSelectDelayTimer > 0)
                  {
                     ...
                     if(_boardSelectDelayTimer <= 0)
                     {
                        ...
                        {
                           _myTurn = _players[parseInt(_messageCache[8])] == myId;
                           if(_myTurn)
                           {
                              _soundMan.playByName(_soundNameTurn);
                              _theGame.loader.content.setPlayerActive();
