package game.microOatHarvest
{
   ...
   public class MicroOatHarvest extends GameBase implements IMinigame
   {
      ...
      private var _audio:Array = ["ajq_miningStinger.mp3","ajq_strawImp1.mp3","ajq_strawImp2.mp3","ajq_strawSlice1.mp3","ajq_strawSlice2.mp3","ajq_textEnter.mp3","ajq_textExit.mp3","ajq_resourceMoving2Bag.mp3","ajq_resourceDrop.mp3","ajq_resourcePopupEnter.mp3","ajq_resourcePopUpExit.mp3","ajq_satchelClose.mp3","ajq_satchelOpen.mp3"];
      
      private var _soundNameStinger:String = _audio[0];
      
      private var _soundNameOatImp1:String = _audio[1];
      
      private var _soundNameOatImp2:String = _audio[2];
      
      private var _soundNameOatSlice1:String = _audio[3];
      
      private var _soundNameOatSlice2:String = _audio[4];
      ...
      public function MicroOatHarvest()
      {
         super();
         init();
      }
      ...
      private function loadSounds() : void
      {
         ...
         _soundMan.addSoundByName(_audioByName[_soundNameOatImp1],_soundNameOatImp1,0.32);
         _soundMan.addSoundByName(_audioByName[_soundNameOatImp2],_soundNameOatImp2,0.65);
         _soundMan.addSoundByName(_audioByName[_soundNameOatSlice1],_soundNameOatSlice1,0.55);
         _soundMan.addSoundByName(_audioByName[_soundNameOatSlice2],_soundNameOatSlice2,0.65);
      ...
      private function init() : void
      {
         if(!_bInit)
         {
            ...
            addChild(_layerMain);
            addChild(_guiLayer);
            loadScene("MicroOatHarvest/room_main.xroom",_audio);
            _bInit = true;
         }
         else
         {
         ...
         if(_sceneLoaded)
         {
            ...
            if(_pauseGame == false)
            {
               if(_theGame && _theGame.loader && _theGame.loader.content)
               {
                  ...
                  if(_theGame.loader.content.ajq_strawImp1)
                  {
                     _theGame.loader.content.ajq_strawImp1 = false;
                     _soundMan.playByName(_soundNameOatImp1);
                  }
                  if(_theGame.loader.content.ajq_strawImp2)
                  {
                     _theGame.loader.content.ajq_strawImp2 = false;
                     _soundMan.playByName(_soundNameOatImp2);
                  }
                  if(_theGame.loader.content.ajq_strawSlice1)
                  {
                     _theGame.loader.content.ajq_strawSlice1 = false;
                     _soundMan.playByName(_soundNameOatSlice1);
                  }
                  if(_theGame.loader.content.ajq_strawSlice2)
                  {
                     _theGame.loader.content.ajq_strawSlice2 = false;
                     _soundMan.playByName(_soundNameOatSlice2);
                  }
