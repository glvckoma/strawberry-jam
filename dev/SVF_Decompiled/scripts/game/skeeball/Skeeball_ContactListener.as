package game.skeeball
{
   ...
   public class Skeeball_ContactListener extends b2ContactListener
   {
      public var contactStack:Array = [];
      
      public function Skeeball_ContactListener()
      {
         super();
      }
      ...
      override public function Result(param1:b2ContactResult) : void
      {
         ...
         if(_loc4_ > 1)
         {
            contactStack.push(new Skeeball_CustomContactPoint(_loc2_,_loc3_,_loc4_,_loc5_));
         }
      }
   }
}
