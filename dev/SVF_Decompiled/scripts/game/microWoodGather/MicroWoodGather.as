package game.microWoodGather
{
   ...
   public class MicroWoodGather extends GameBase implements IMinigame
   {
      ...
      private var _audio:Array = ["ajq_miningStinger.mp3","ajq_textEnter.mp3","ajq_textExit.mp3","ajq_woodDrop1.mp3","ajq_woodDrop2.mp3","ajq_woodDrop3.mp3","ajq_woodDrop4.mp3","ajq_woodDrop5.mp3","ajq_woodGroundImp.mp3","ajq_woodReleased.mp3","ajq_resourceMoving2Bag.mp3","ajq_resourceDrop.mp3","ajq_resourcePopupEnter.mp3","ajq_resourcePopUpExit.mp3","ajq_satchelClose.mp3","ajq_satchelOpen.mp3"];
      
      private var _soundNameStinger:String = _audio[0];
      
      private var _soundNameTextEnter:String = _audio[1];
      
      private var _soundNameTextExit:String = _audio[2];
      
      private var _soundNameDrop1:String = _audio[3];
      
      private var _soundNameDrop2:String = _audio[4];
      
      private var _soundNameDrop3:String = _audio[5];
      
      private var _soundNameDrop4:String = _audio[6];
      
      private var _soundNameDrop5:String = _audio[7];
      
      private var _soundNameWoodImp:String = _audio[8];
      
      private var _soundNameWoodReleased:String = _audio[9];
      
      private var _soundNameResourceMove:String = _audio[10];
      
      private var _soundNameResourceDrop:String = _audio[11];
      
      private var _soundNamePopupEnter:String = _audio[12];
      
      private var _soundNamePopupExit:String = _audio[13];
      
      private var _soundNameSatchelClose:String = _audio[14];
      
      private var _soundNameSatchelOpen:String = _audio[15];
      
      public function MicroWoodGather()
      {
         super();
         init();
      }
      ...
      private function loadSounds() : void
      {
         ...
         _soundMan.addSoundByName(_audioByName[_soundNameDrop1],_soundNameDrop1,0.95);
         _soundMan.addSoundByName(_audioByName[_soundNameDrop2],_soundNameDrop2,0.95);
         _soundMan.addSoundByName(_audioByName[_soundNameDrop3],_soundNameDrop3,0.95);
         _soundMan.addSoundByName(_audioByName[_soundNameDrop4],_soundNameDrop4,0.95);
         _soundMan.addSoundByName(_audioByName[_soundNameDrop5],_soundNameDrop5,0.95);
         _soundMan.addSoundByName(_audioByName[_soundNameWoodImp],_soundNameWoodImp,1.1);
         _soundMan.addSoundByName(_audioByName[_soundNameWoodReleased],_soundNameWoodReleased,2);
      ...
      private function init() : void
      {
         if(!_bInit)
         {
            ...
            addChild(_layerMain);
            addChild(_guiLayer);
            loadScene("MicroWoodGather/room_main.xroom",_audio);
            _bInit = true;
         }
         else
         {
         ...
         if(_sceneLoaded)
         {
            ...
            if(_pauseGame == false)
            {
               if(_theGame && _theGame.loader && _theGame.loader.content)
               {
                  ...
                  if(_theGame.loader.content.ajq_woodDrop1)
                  {
                     _theGame.loader.content.ajq_woodDrop1 = false;
                     _soundMan.playByName(_soundNameDrop1);
                  }
                  if(_theGame.loader.content.ajq_woodDrop2)
                  {
                     _theGame.loader.content.ajq_woodDrop2 = false;
                     _soundMan.playByName(_soundNameDrop2);
                  }
                  if(_theGame.loader.content.ajq_woodDrop3)
                  {
                     _theGame.loader.content.ajq_woodDrop3 = false;
                     _soundMan.playByName(_soundNameDrop3);
                  }
                  if(_theGame.loader.content.ajq_woodDrop4)
                  {
                     _theGame.loader.content.ajq_woodDrop4 = false;
                     _soundMan.playByName(_soundNameDrop4);
                  }
                  if(_theGame.loader.content.ajq_woodDrop5)
                  {
                     _theGame.loader.content.ajq_woodDrop5 = false;
                     _soundMan.playByName(_soundNameDrop5);
                  }
                  if(_theGame.loader.content.ajq_woodGroundImp)
                  {
                     _theGame.loader.content.ajq_woodGroundImp = false;
                     _soundMan.playByName(_soundNameWoodImp);
                  }
                  if(_theGame.loader.content.ajq_woodReleased)
                  {
                     _theGame.loader.content.ajq_woodReleased = false;
                     _soundMan.playByName(_soundNameWoodReleased);
                  }
