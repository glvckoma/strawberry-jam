package game.microStoneMining
{
   ...
   public class MicroStoneMining extends GameBase implements IMinigame
   {
      ...
      private var _audio:Array = ["ajq_miningStinger.mp3","ajq_rockImp1.mp3","ajq_rockImp2.mp3","ajq_rockImp3.mp3","ajq_rockImp4.mp3","ajq_rockImp5.mp3","ajq_rockImp6.mp3","ajq_rockImp7.mp3","ajq_textEnter.mp3","ajq_textExit.mp3","ajq_resourceMoving2Bag.mp3","ajq_resourceDrop.mp3","ajq_resourcePopupEnter.mp3","ajq_resourcePopUpExit.mp3","ajq_satchelClose.mp3","ajq_satchelOpen.mp3"];
      
      private var _soundNameStinger:String = _audio[0];
      
      private var _soundNameImp1:String = _audio[1];
      
      private var _soundNameImp2:String = _audio[2];
      
      private var _soundNameImp3:String = _audio[3];
      
      private var _soundNameImp4:String = _audio[4];
      
      private var _soundNameImp5:String = _audio[5];
      
      private var _soundNameImp6:String = _audio[6];
      
      private var _soundNameImp7:String = _audio[7];
      
      private var _soundNameTextEnter:String = _audio[8];
      
      private var _soundNameTextExit:String = _audio[9];
      ...
      public function MicroStoneMining()
      {
         super();
         init();
      }
      ...
      private function loadSounds() : void
      {
         ...
         _soundMan.addSoundByName(_audioByName[_soundNameImp1],_soundNameImp1,0.85);
         _soundMan.addSoundByName(_audioByName[_soundNameImp2],_soundNameImp2,0.85);
         _soundMan.addSoundByName(_audioByName[_soundNameImp3],_soundNameImp3,0.85);
         _soundMan.addSoundByName(_audioByName[_soundNameImp4],_soundNameImp4,0.85);
         _soundMan.addSoundByName(_audioByName[_soundNameImp5],_soundNameImp5,0.85);
         _soundMan.addSoundByName(_audioByName[_soundNameImp6],_soundNameImp6,0.85);
         _soundMan.addSoundByName(_audioByName[_soundNameImp7],_soundNameImp7,0.8);
      ...
      private function init() : void
      {
         if(!_bInit)
         {
            ...
            addChild(_layerMain);
            addChild(_guiLayer);
            loadScene("MicroStoneMining/room_main.xroom",_audio);
            _bInit = true;
         }
         else
         {
         ...
         if(_sceneLoaded)
         {
            ...
            if(_pauseGame == false)
            {
               if(_theGame && _theGame.loader && _theGame.loader.content)
               {
                  ...
                  if(_theGame.loader.content.ajq_rockImp1)
                  {
                     _theGame.loader.content.ajq_rockImp1 = false;
                     _soundMan.playByName(_soundNameImp1);
                  }
                  if(_theGame.loader.content.ajq_rockImp2)
                  {
                     _theGame.loader.content.ajq_rockImp2 = false;
                     _soundMan.playByName(_soundNameImp2);
                  }
                  if(_theGame.loader.content.ajq_rockImp3)
                  {
                     _theGame.loader.content.ajq_rockImp3 = false;
                     _soundMan.playByName(_soundNameImp3);
                  }
                  if(_theGame.loader.content.ajq_rockImp4)
                  {
                     _theGame.loader.content.ajq_rockImp4 = false;
                     _soundMan.playByName(_soundNameImp4);
                  }
                  if(_theGame.loader.content.ajq_rockImp5)
                  {
                     _theGame.loader.content.ajq_rockImp5 = false;
                     _soundMan.playByName(_soundNameImp5);
                  }
                  if(_theGame.loader.content.ajq_rockImp6)
                  {
                     _theGame.loader.content.ajq_rockImp6 = false;
                     _soundMan.playByName(_soundNameImp6);
                  }
                  if(_theGame.loader.content.ajq_rockImp7)
                  {
                     _theGame.loader.content.ajq_rockImp7 = false;
                     _soundMan.playByName(_soundNameImp7);
                  }
