package game.pVP_RockPaperScissor
{
   ...
   public class PVP_RockPaperScissor extends GameBase implements IMinigame
   {
      ...
      public static const TURN_TIME:int = 5;
      ...
      private var _audio:Array = ["pvp_stinger_draw.mp3","pvp_stinger_fail.mp3","pvp_stinger_win.mp3","pvp_stinger_turn.mp3","rps_select.mp3","rps_drum_roll.mp3","rps_stinger_reveal.mp3","rps_rollover.mp3","rps_hand_thrust.mp3","popup_pvp_RedText_enter.mp3","popup_pvp_RedText_exit.mp3","pvp_rps_timer_count_down.mp3","pvp_rps_timer_throw.mp3"];
      ...
      private var _soundNameDrumRoll:String = _audio[5];
      
      private var _soundNameReveal:String = _audio[6];
      
      private var _soundNameRollover:String = _audio[6];
      
      private var _soundNameHandThrust:String = _audio[6];
      
      private var _soundNameRedTextEnter:String = _audio[9];
      
      private var _soundNameRedTextExit:String = _audio[10];
      
      private var _soundNameTimerCountdown:String = _audio[11];
      
      private var _soundNameTimerThrow:String = _audio[12];
      
      public function PVP_RockPaperScissor()
      {
         super();
         _iWon = false;
      ...
      {
         _soundMan.addSoundByName(_audioByName[_soundNameTie],_soundNameTie,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameLose],_soundNameLose,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameWin],_soundNameWin,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameTurn],_soundNameTurn,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameSelect],_soundNameSelect,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameDrumRoll],_soundNameDrumRoll,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameReveal],_soundNameReveal,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameRollover],_soundNameRollover,0.4);
         _soundMan.addSoundByName(_audioByName[_soundNameHandThrust],_soundNameHandThrust,0.4);
         ...
         _soundMan.addSoundByName(_audioByName[_soundNameTimerCountdown],_soundNameTimerCountdown,0.2);
         _soundMan.addSoundByName(_audioByName[_soundNameTimerThrow],_soundNameTimerThrow,0.2);
      }
      ...
      private function init() : void
      {
         if(!_bInit)
         {
            ...
            addChild(_layerMain);
            addChild(_guiLayer);
            loadScene("PVP_RockPaperScissors/room_main.xroom",_audio);
            _bInit = true;
         }
         else
         {
      ...
      public function startRound() : void
      {
         ...
         _theGame.loader.content.thumpSound = false;
         _theGame.loader.content.clickSound = false;
         if(_pIDs[0] == myId)
         {
      ...
      public function heartbeat(param1:Event) : void
      {
         ...
         if(_sceneLoaded)
         {
            if(_serverStarted)
            {
               ...
               if(_theGame.loader.content.timer_throw)
               {
                  _theGame.loader.content.timer_throw = false;
                  _soundMan.playByName(_soundNameTimerThrow);
               }
               ...
               if(_gameState == 5)
               {
                  if(_boardSelectDelayTimer > 0)
                  {
                     ...
                     {
                        _soundMan.playByName(_soundNameReveal);
                        if(_players[0] == myId)
                        {
                  ...
                  else if(_turnTimer > 0)
                  {
                     ...
                     if(_theGame.loader.content.thumpSound)
                     {
                        _theGame.loader.content.thumpSound = false;
                        _soundMan.playByName(_soundNameHandThrust);
                     }
                     if(_theGame.loader.content.clickSound)
                     {
                        _theGame.loader.content.clickSound = false;
                     ...
                     if(_turnTimer <= 0)
                     {
                        ...
                        _loc2_ = [];
                        _loc2_[0] = "time";
                        _loc2_[1] = _theGame.loader.content.markedHand;
                        MinigameManager.msg(_loc2_);
                     }
                     _theGame.loader.content.time(_turnTimer,5);
                  }
               }
