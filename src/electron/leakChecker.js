...
async function startLeakCheck(options) {
    ...
    // Note: Internal isPaused/isStopped flags removed, now relies on passed functions

    // Remove sendStatus function - progress strings interfered with state updates
    // const sendStatus = (status, details = null) => {
    //     if (webContents && !webContents.isDestroyed()) {
    //         webContents.send('leak-check-progress', { status, details });
    //     }
    // };
