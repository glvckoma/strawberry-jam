  ...
  <ajd-text-input id="username-input" placeholder="username" type="text"></ajd-text-input>
    ...
    async logIn() {
      ...
      try {
        ...
        const uuidSpoofingEnabled = this.uuidSpooferToggle ? this.uuidSpooferToggle.checked : 
                                   await window.ipc.invoke('get-setting', 'uuid_spoofer_enabled');
        
        if (uuidSpoofingEnabled) {
